...
class EncryptionTool:
    ...
    def __init__(self, user_file, user_key, user_salt):
        ...
        self.decrypt_output_file = ".".join(self.decrypt_output_file[:-1]) \
            + "__dec__." + self.decrypt_output_file[-1]
...
class MainWindow:
    ...
    def __init__(self, root):
        ...
        root.title("AES CFB MODE - Asanov E.K.")
        ...
        self.file_entry_label = tk.Label(
            root,
            text="Введите путь к файлу или нажмите кнопку ВЫБРАТЬ ФАЙЛ",
            bg="#eeeeee",
            anchor=tk.W
        )
